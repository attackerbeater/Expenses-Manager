...
class ExpenseCategoriesController extends Controller
{
    ...
    public function index()
    {
        ...
        $user = Auth::user();
        return view('admin.expense_categories.index', compact('expense_categories', 'user'));
    }
    ...
    public function create()
    {
        ...
        $user = Auth::user();
        return view('admin.expense_categories.create', compact('created_bies', 'user'));
    }
    ...
    public function edit($id)
    {
        ...
        $user = Auth::user();
        return view('admin.expense_categories.edit', compact('expense_category', 'created_bies', 'user'));
    }
    ...
    public function show($id)
    {
        ...
        $expense_category = ExpenseCategory::findOrFail($id);
        $user = Auth::user();
        return view('admin.expense_categories.show', compact('expense_category', 'expenses', 'user'));
    }
