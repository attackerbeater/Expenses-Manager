...
class ExpensesController extends Controller
{
    ...
    public function index()
    {
        ...
        $user = Auth::user();
        return view('admin.expenses.index', compact('expenses', 'user'));
    }
    ...
    public function create()
    {
        ...
        $user = Auth::user();
        return view('admin.expenses.create', compact('expense_categories', 'created_bies', 'user'));
    }
    ...
    public function edit($id)
    {
        ...
        $user = Auth::user();
        return view('admin.expenses.edit', compact('expense', 'expense_categories', 'created_bies', 'user'));
    }
    ...
    public function show($id)
    {
        ...
        $expense = Expense::findOrFail($id);
        $user = Auth::user();
        return view('admin.expenses.show', compact('expense', 'user'));
    }
